...
// @ts-ignore
import AdSelect from './select.vue';
import { reactive, ref, watch } from 'vue';

// CONFIGURATION
const meta = {
    title: 'components/Select (in progress)',
    component: AdSelect,
    tags: ['autodocs'],
    parameters: {
        docs: {
...
} satisfies Meta<typeof AdSelect>;
...
export const Default: Story = {
    args: {
        label: "Select",
        options: [
            { text: "Ed Sheeran", key: "edsheeran"},
            { text: "Adele", key: "adele"},
            { text: "The script", key: "thescript"},
            { text: "James Arthur", key: "arthur"},
          ]
    },
};
